...
class FastWinPosition:
    ...
    def create_fast_win_pos(self):
        ...
        setups = {stratego.Side.red: red_setup, stratego.Side.blue: blue_setup}

        setup = setups[self.moving_side]
        ...
        setup = setups[self.moving_side.flip()]
        for sq, type_ in setup.items():
        ...
        for side in setups:
            assert stratego.verify_setup_dict(setups[side], side)
